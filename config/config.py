...
def get_arguments():
    ...
    parser.add_argument('--max_size', type=int,help='image maximum size at the coarser scale', default=250)
    ...
    parser.add_argument('--pix_shuffle_p', type=float, default=0.005, help='pixel shuffle rate (0.005 => 0.5%)')
